"""a_blockchain_based_architecture URL Configuration
...
from a_blockchain_based_architecture import settings
...
urlpatterns = [
    ...
    url(r'^Cybersecure_Smart_City_Prediction_Status/$', remoteuser.Cybersecure_Smart_City_Prediction_Status, name="Cybersecure_Smart_City_Prediction_Status"),
    ...
    url(r'^View_Prediction_Cybersecure_Smart_City_Details_Ratio/$', serviceprovider.View_Prediction_Cybersecure_Smart_City_Details_Ratio, name="View_Prediction_Cybersecure_Smart_City_Details_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Cybersecure_Smart_City_Details/$', serviceprovider.View_Prediction_Cybersecure_Smart_City_Details, name="View_Prediction_Cybersecure_Smart_City_Details"),
