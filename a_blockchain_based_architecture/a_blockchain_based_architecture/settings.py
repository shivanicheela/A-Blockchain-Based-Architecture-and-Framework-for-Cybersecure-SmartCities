...
ROOT_URLCONF = 'a_blockchain_based_architecture.urls'
...
WSGI_APPLICATION = 'a_blockchain_based_architecture.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'a_blockchain_based_architecture',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
