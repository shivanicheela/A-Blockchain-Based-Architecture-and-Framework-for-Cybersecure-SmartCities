...
--
-- Database: `a_blockchain_based_architecture`
--
CREATE DATABASE IF NOT EXISTS `a_blockchain_based_architecture` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `a_blockchain_based_architecture`;
...
('5qviifb1blstlo4lfe7r5kc1o5n9u0x8', 'eyJ1c2VyaWQiOjR9:1pIUNw:OT9DY2nv2yp_cjPRqHJJxVbHTeCKxyIBUJ4ENzqPVZk', '2023-02-02 12:51:16.452127'),
...
('fq9c1rwp55pr3db0fnpyeur73p6pl74e', 'eyJ1c2VyaWQiOjd9:1rklrW:58ufM7NlDFsYxDL9bd6en_DWCDRUxpKVNRu5Ks-aIZY', '2024-03-28 14:15:14.321044'),
...
('i9advsl2yp0w036mltcz1d3hikonyw3u', 'eyJ1c2VyaWQiOjV9:1rkl0b:7TLbsq_Y-VcWE1OknphGFONfwMv3AuzWuqbMGFX6yzM', '2024-03-28 13:20:33.409029'),
...
('svek3zssev4yp2ajplstd6qclfi5f91t', 'eyJ1c2VyaWQiOjN9:1pIT48:xw9_Qtt4Mlc7vmejuo3-nKyydpNOuwgdkvRv46JjO9I', '2023-02-02 11:26:44.876333'),
...
(5, 'Rajesh', 'Rajesh123@gmail.com', 'Rajesh', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
(6, 'Manjunath', 'tmksmanju14@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
(7, 'tmksmanju', 'tmksmanju14@gmail.com', 'tmksmanju', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8983,4th Cross,Rajajinagar', 'Male');
...
(16, 'Naive Bayes', '61.693548387096776'),
(17, 'SVM', '54.03225806451613'),
(18, 'Logistic Regression', '59.67741935483871'),
(19, 'Decision Tree Classifier', '55.24193548387096'),
(20, 'Extra Tree Classifier', '58.46774193548387');
...
--
-- Table structure for table `remote_user_predict_cybersecure_smart_city`
--

CREATE TABLE IF NOT EXISTS `remote_user_predict_cybersecure_smart_city` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `optimization_block` varchar(300) NOT NULL,
  `features_block` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;

--
-- Dumping data for table `remote_user_predict_cybersecure_smart_city`
--

INSERT INTO `remote_user_predict_cybersecure_smart_city` (`id`, `RID`, `city`, `city_ascii`, `lat`, `lng`, `country`, `iso2`, `iso3`, `admin_name`, `capital`, `population`, `optimization_block`, `features_block`, `Prediction`) VALUES
(1, '239.255.255.250-10.42.0.1-1900-44477-17', 'Mumbai', 'Mumbai', '19.017', '72.857', 'India', 'IN', 'IND', 'Maharatira', 'admin', '18978000', 'waste disposal ', 'better surveillance for security ', 'Secured'),
(2, '183.79.248.124-10.42.0.211-443-40398-6', 'Buenos Aires', 'Buenos Aires', '-34.6025', '-58.3975', 'Argentina', 'AR', 'ARG', 'Buenos Aires, Ciudad AutÃ³noma de', 'primary', '12795000', 'mobility', 'better governance ', 'Not Secured'),
(3, '172.217.10.74-10.42.0.151-443-57211-6', 'Istanbul', 'Istanbul', '41.105', '29.01', 'Turkey', 'TR', 'TUR', 'Ä°stanbul', 'admin', '10061000', 'street furniture management', 'smart infrastructure ', 'Secured'),
(4, '172.217.7.164-10.42.0.42-443-38539-6', 'Miami', 'Miami', '25.7839', '-80.2102', 'United States', 'US', 'USA', 'Florida', 'Unknown', '6381966', 'mobility', 'better surveillance for security ', 'Secured');
